...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $hapus = mysqli_query($koneksi, "DELETE FROM resto_reviews WHERE id='$id'");
    if ($hapus) {
        echo "<script>
            alert('Data berhasil dihapus');
            window.location.href = 'resto.review.php';
        </script>";
    } else {
        echo "<script>
        ...
        <div class="col-md-10 p-5 pt-2">
            ...
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    <?php
                    include 'koneksi.php';
                    $query = mysqli_query($koneksi, "SELECT * FROM resto_reviews");
                    $no = 1;
