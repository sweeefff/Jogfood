...
$dataPerPage = 6;
$totalData = count(query("SELECT * FROM kuliner WHERE kategori = 'Tradisional'"));
...
$query = "SELECT k.id, k.nama, k.deskripsi, k.gambar,
		COALESCE(AVG(r.rating), 0) AS avg_rating
		FROM kuliner k
		LEFT JOIN kuliner_reviews r ON k.id = r.kuliner_id
		WHERE k.kategori = 'Non-Tradisional'
	GROUP BY k.id, k.nama, k.deskripsi, k.gambar
	ORDER BY
    	CASE
		...
		<div class="container">
			<div class="row mb-4">
				<div class="col-12 mt-5">
					<h2 class="section-title" style="margin-top: 80px; margin-left: 440px; font-size: 30px;">MAKANAN
						NON-TRADISIONAL</h2>
				</div>
			</div>
			<?php
					...
					foreach ($data as $key => $row):
						...
						<div class="col-md-4 mb-4">
							<div class="card">
								...
								<a href='kuliner.php?id=<?php echo $row['id']; ?>&action=show'><button
