...
$dataPerPage = 6;
$totalData = count(query("SELECT * FROM kuliner"));
...
$query = "SELECT k.id, k.nama, k.deskripsi, k.gambar, k.kategori,
	...
	GROUP BY k.id, k.nama, k.deskripsi, k.gambar, k.kategori
	ORDER BY
    	CASE
		...
		<div class="container">
			<div class="row mb-4">
				<div class="col-12 mt-5">
					<h2 class="section-title" style="margin-top: 80px; margin-left: 440px; font-size: 30px;">Viral Food
					</h2>
				</div>
			</div>
			<?php
