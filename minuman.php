...
$dataPerPage = 6;
$totalData = count(query("SELECT * FROM minuman"));
...
$query = "SELECT k.id, k.nama, k.deskripsi, k.gambar,
		...
		FROM minuman k
		LEFT JOIN minuman_reviews r ON k.id = r.minuman_id
        ...
        <div class="container">
            <div class="row mb-4">
                <div class="col-12 mt-5">
                    <h2 class="section-title" style="margin-top: 80px; margin-left: 440px; font-size: 30px;">MINUMAN
                    </h2>
                </div>
            </div>
			<?php
					...
					foreach ($data as $key => $row):
						...
						<div class="col-md-4 mb-4">
							<div class="card">
								...
								<a href='detail.php?id=<?php echo $row['id']; ?>&action=show'><button
