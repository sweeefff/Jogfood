...
<body>
    ...
    <div class="row g-0 mt-5">
        ...
        <div class="col-md-10 p-5 pt-2">
            <h3><i class="fas fa-wine-glass me-2"></i> Daftar minuman</h3>
            <hr>
            <button type="button" class="btn btn-primary mb-2" data-bs-toggle="modal" data-bs-target="#tambahDataModal">
                <i class="fas fa-plus-circle me-2"></i>TAMBAH DATA MINUMAN
            </button>
            <div class="col-md-10 p-5 pt-2">
                <!-- Modal Tambah Data -->
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="tambahDataLabel">Tambah Data Minuman</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <form action="tambah_mnm.php" method="POST" enctype="multipart/form-data">
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <label for="gambar" class="form-label">Gambar Kuliner</label>
            ...
            <div class="modal fade" id="editDataModal" tabindex="-1" aria-labelledby="editDataLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="editDataLabel">Edit Data Minuman</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <form action="ubah_mnm.php" method="POST" enctype="multipart/form-data">
                                <input type="hidden" id="edit-id" name="id">
                                <div class="mb-3">
                                    <label for="edit-nama" class="form-label">Nama Minuman</label>
                    ...
                    while ($data = mysqli_fetch_assoc($query)) {
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="hapus_mnm.php?id=<?php echo $data['id']; ?>" class="btn btn-danger btn-sm"
