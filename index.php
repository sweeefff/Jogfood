...
$query2 = "SELECT k.id, k.nama, k.price, k.location, k.gambar,
                COALESCE(AVG(r.rating), 0) AS avg_rating
        FROM restoran k
        LEFT JOIN resto_reviews r ON k.id = r.resto_id
        GROUP BY k.id, k.nama, k.price, k.location, k.gambar ORDER BY avg_rating DESC LIMIT 0, 3";
				...
				<div class="container">
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-12"><img style="box-shadow: 20px 20px 0px #d65106;"
								src="images/about-img2.jpg" alt="" class="img-fluid"></div>
						<div class="col-lg-6 col-md-6 col-sm-12 text-center">
